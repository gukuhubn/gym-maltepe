...
Ön tasarım, uygulama projesi ve bütçe paketi · **Rev F** · 17 Eylül 2026
...
| `Gym_CAD_Seti_DXF.zip` | **CAD seti** — 4 birleşik DXF R2010 **+ 14 tekil pafta dosyası** (`paftalar/`: her pafta kendi DXF'i, model uzayında yalnız o paftanın geometrisi), 61 katman, katman listesi, okuma notu |
| `Gym_CAD_Paftalar.pdf` | CAD paftalarının önizlemesi — 14 pafta, her biri **kendi bağımsız DXF dosyasından** basılır |
...
python3 tools/build_tekhat.py         # ADP tek hat şeması (8 pafta, IEC 60617 / 61439)
